...
SEARCH_INDEX = [
    ...
    # ── Elektrokemi ──
    {"title": "Galvanisk celle – katode og anode", "keywords": ["katode", "anode", "galvanisk", "hvilken reduceres", "hvilken oxideres", "e° givet", "bestem katode", "e° manuel", "reduktionspotentiale", "cellespænding manuelt", "byg en celle"], "page": "electrochemistry", "tab": "Byg en celle", "description": "Indtast to E°-værdier – appen finder katode/anode og beregner E°celle"},
    {"title": "ΔG og K fra E°", "keywords": ["delta g fra e", "k fra e°", "ligevægtskonstant fra celle", "gibbs elektrokemi", "ΔG elektrokemi", "nfe"], "page": "electrochemistry", "tab": "ΔG og K", "description": "ΔG° = −nFE° og K fra cellespænding"},
    {"title": "Faradays lov (elektrolyse)", "keywords": ["faraday", "faradays lov", "elektrolyse", "afsættet masse", "coulomb", "strøm tid mol", "ampere tid", "aflejret", "electrolysis"], "page": "electrochemistry", "tab": "⚡ Faradays lov", "description": "m = MIt/(nF) – masse afsat ved elektrolyse"},
    # ── Buffer + syre/base ──
    {"title": "Buffer efter tilsætning af syre/base", "keywords": ["buffer naoh", "buffer hcl", "tilsæt naoh til buffer", "ph efter tilsætning", "buffer og syre", "buffer og base", "ændring ph buffer", "ice buffer", "delta ph buffer"], "page": "acids-bases", "tab": "Buffer", "description": "pH før og efter tilsætning af NaOH eller HCl til en bufferløsning"},
    # ── Kolligative egenskaber ──
    {"title": "Sammenlign frysepunktsnedsættelse", "keywords": ["sammenlign opløsninger", "nacl vs cacl2", "van't hoff faktor", "bedste frostvæske", "lavest frysepunkt", "frysepunkt sammenlign", "compare solutions", "kolligativ sammenlign"], "page": "koge-fryse", "tab": "🆚 Sammenlign opløsninger", "description": "Sammenlign frysepunktsnedsættelse for to opløsninger side om side"},
    # ── Gibbs ──
    {"title": "Find temperatur (Gibbs)", "keywords": ["find temperatur", "find t", "gibbs temperatur", "ved hvilken temperatur", "t fra delta h delta s", "kogepunkt beregn", "ligevægtstemp", "spontan temperatur", "overgang temperatur"], "page": "thermochemistry", "tab": "🔍 Find ΔH°/ΔG°/ΔS°", "description": "T = ΔH°/ΔS° – find temperaturen hvor ΔG° = 0 (fx kogepunkt)"},
    # ── Le Chatelier ──
    {"title": "Le Chatelier – forudsig ligevægtsforskydning", "keywords": ["le chatelier", "forskydning", "ligevægt ændring", "tryk reaktion", "temperatur ligevægt", "tilsæt reaktant", "forudsig retning", "ligevægt forstyrrelse", "katalysator ligevægt", "inert gas ligevægt"], "page": "ligevaegt", "tab": "⚖️ Le Chatelier", "description": "Forudsig i hvilken retning en ligevægt forskydes ved ændring i tryk, T, koncentration m.m."},
    # ── Ksp ──
    {"title": "Opløser saltet sig fuldt ud? (Ksp)", "keywords": ["opløser fuldt ud", "ksp tilsæt masse", "salt opløselig mængde", "bundfald eller ej", "maksimalt opløseligt", "gram salt ksp", "ksp masse"], "page": "ligevaegt", "tab": "💧 Opløselighed (Ksp)", "description": "Afgør om en given mængde salt opløses fuldt ud eller giver bundfald"},
    {"title": "Opløselighed fra Ksp (masse i volumen)", "keywords": ["opløselighed ksp", "masse fra ksp", "mg per liter", "gram opløst", "molare opløselighed", "s fra ksp", "ksp til mg"], "page": "ligevaegt", "tab": "💧 Opløselighed (Ksp)", "description": "Beregn opløselighed i g/L, mg/100mL m.m. fra Ksp og molarmasse"},
    # ── Formelsamling ──
    {"title": "Eksamenskoncepter (sandt/falsk)", "keywords": ["sandt falsk", "udsagn", "eksamenskoncepter", "korrekt udsagn", "hvilke er sande", "true false", "kemiske udsagn", "koncepter oversigt"], "page": "formelsamling", "tab": None, "description": "Oversigt over typiske sandt/falsk eksamenskoncepter inden for alle kemiske emner"},
    # ── Graham og kinetik ──
...
def _show_bindingskarakter_section():
    ...
    # Pauling elektronegativity – synkroniseret med _EN_TABLE
    _EN = _EN_TABLE
...
_EN_TABLE = {
    ...
    "La": 1.10, "W": 2.36, "Pt": 2.28, "Au": 2.54, "Hg": 2.00,
    "Tl": 1.62, "Pb": 2.33, "Bi": 2.02, "Fr": 0.70, "Ra": 0.90,
    "At": 2.20,
}
...
def _bonding_info(s: Substance) -> dict:
    ...
    METALS = {
        ...
        "Ti","V","W","Mo","Pd","Hg","Sc","Y","Zr","Nb","Tc","Ru","Rh","Ir","Os",
    }
